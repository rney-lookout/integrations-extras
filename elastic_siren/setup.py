...
# Get version info
ABOUT = {}
with open(path.join(HERE, 'datadog_checks', 'elastic_siren', '__about__.py')) as f:
    exec(f.read(), ABOUT)
...
setup(
    name='datadog-elastic_siren',
    version=ABOUT['__version__'],
    description='The elastic-siren check',
    long_description=long_description,
    long_description_content_type='text/markdown',
    keywords='datadog agent elastic_siren check',
    # The project's main homepage.
    url='https://github.com/DataDog/integrations-extras',
    # Author details
    author='Richard Ney',
    author_email='richard.ney@lookout.com',
    # License
    ...
    packages=['datadog_checks.elastic_siren'],
